...
export default function LoginPage() {
 ...
 points="127,23 170,66 170,134 127,177 73,177 30,134 30,66 73,23" style={{ fill: "none", stroke: "var(--foreground)", strokeWidth: 3, strokeLinejoin: "round" }}/> <text x="100" y="140" textAnchor="middle" fontFamily="Arial Black, Impact, sans-serif" fontWeight="900" fontSize="84" letterSpacing="-3" style={{ fill: "var(--accent-hex)" }}>AP</text> </svg> {/* Wordmark */}
