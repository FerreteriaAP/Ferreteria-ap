        ...
        <div className="doc">
          ...
          <div className="header-grid">
            <div>
              ...
              {/* Solo fecha de emisión — más grande y en negrita */}
              <div className="fecha-emision">
                <span className="fecha-emision-lbl">Fecha:</span>
                <span className="fecha-emision-val">{fechaEmision}</span>
              </div>
            </div>
          ...
          <div className="cli-box">
            <div className="cli-grid">
              ...
              <div>
                ...
                <div className="cli-row"><span className="cli-lbl">Válida hasta:</span> <strong>{fechaVence}</strong></div>
              </div>
            </div>
          </div>

          {/* TABLA — Código · Descripción · Unidad · Cantidad · Precio · ITBIS · Total */}
          <table className="tbl">
            <thead>
              <tr>
          ...
          {/* FOOTER — solo al final del documento (última página) */}
