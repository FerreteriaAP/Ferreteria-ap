...
export default async function ContactoPage({ params }: PageProps) {
 ...
 </div> <Link href={`/contactos/${id}/editar`} className={buttonVariants({ variant: "outline" })}> Editar
 </Link> </div> <div className="grid grid-cols-1 md:grid-cols-2 gap-4"> {/* Datos generales */}
