...
export default async function ImprimirNominaPage({ params }: PageProps) {
 ...
 <p className="no-print text-center text-sm text-gray-500 pt-6 pb-2">
   Presiona <strong>Ctrl + P</strong> (Windows) o <strong>⌘ + P</strong> (Mac) para imprimir · Recomendado: papel carta, márgenes reducidos
 </p>
 <div className="volantes-container">
   ...
   {nomina.empleados.map((l: any, idx: number) => {
     ...
     return (
       <div key={l.id} className={`volante${idx < nomina.empleados.length - 1 ? " page-break" : ""}`}>
         ...
         <div className="tables-grid">
           <div className="tbl-block">
             ...
             <table><tbody>
               ...
               <tr className="sub-total"><td>Total Bruto</td><td className="num">{fmtNum(bruto)}</td></tr>
             </tfoot></table>
           </div>
           <div className="tbl-block">
             ...
             <table><tbody>
               ...
               <tr className="sub-total"><td>Total Descuentos</td><td className="num neg">({fmtNum(deuda)})</td></tr>
             </tfoot></table>
           </div>
         </div>
         ...
         <div className="neto-bar">
           ...
           <span className="neto-amount">RD$ {fmtNum(neto)}</span>
         </div>
 ...
 <style>{`
   * { box-sizing: border-box; margin: 0; padding: 0; }
   ...
   .volantes-container { max-width: 720px; margin: 0 auto; padding: 0 16px 32px; }

   .volante {
     background: #fff; border: 1px solid #ddd; border-radius: 8px;
     padding: 22px 28px 20px; margin-top: 24px;
   ...
   @media print {
     ...
     .volante {
       border: 1px solid #bbb; border-radius: 0; box-shadow: none;
